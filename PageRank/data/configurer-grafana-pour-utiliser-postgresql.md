...
#### Création de la base de données :
  Nous supposons que postgres est installé si non se reférer à la documentation de son instalation : [Postgres installation](https://wiki.perras.fr/link/10#bkmrk-a--installation-de-p).

  Créer une base de donnée postgres  avec comme informations :
  - name data base : grafana_db
  - user data base : grafana

  Le quide de création de la base de données, utilisateurs et d'accord de droits se trouve dans  : [Create data base](https://wiki.perras.fr/link/13#bkmrk-le-cas-d%27application).
